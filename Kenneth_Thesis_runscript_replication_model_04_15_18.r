...
type.p <- matrix.m1.partyid[,3] %>% as.factor() #so it will be treated as a categorical variable
...
type.i <- matrix.m1.ideology[,3] %>% as.factor() #so it will be treated as a categorical variable
