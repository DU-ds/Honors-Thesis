...
vars.m2f <- cbind(anes.12$defense.spending, anes.12$urb.unrest, anes.12$ussr.cooperation, anes.12$FS.foreign.aid, anes.12$FS.space, anes.12$FS.crime, anes.12$year_sequence)
#foreign policy subset of vars.m2f 
